...
description: Use when creating individual Compose UI components in the core/design module to match a design specification — builds one component at a time with @Preview, following existing design system patterns and theme tokens.
---
